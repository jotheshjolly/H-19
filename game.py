...
class Game(object):
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                self.display_message(screen,"It is an arcade Game a maze containing various dots known as IMMUNE DOTS, and CORONA VIRUS.The VIRUS roam the maze, trying to kill HUMAN.If any of the VIRUS hit HUMAN, he loses a life;the game is over.")
            else:
